#!/bin/bash
# Rofi-based project selector for launching terminal
...
selected=$(echo "$menu" | rofi -dmenu -i -p "Open Terminal in" -format s -select "~/ (Home)")
...
# Launch ghostty in the selected directory
