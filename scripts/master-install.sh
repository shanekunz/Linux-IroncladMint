...
run_script "install-terminal-utils.sh"
...
run_script "install-beads.sh"
run_script "install-claude-cli.sh"
run_script "install-codex.sh"
run_script "install-opencode.sh"
run_script "install-t3-code.sh"
run_script "install-ollama.sh"
